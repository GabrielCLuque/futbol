...
<body>
    <div class="container mx-auto mt-8">
        ...
        <div class="flex justify-start mt-4">
            <a href="<?php echo e(route('partidos.all')); ?>" class="volver-button flex items-center text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">Volver a la lista de partidos</a>
        </div>
    </div>
</body>
</html>
