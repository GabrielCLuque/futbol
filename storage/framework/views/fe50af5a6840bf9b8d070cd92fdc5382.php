...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <li>
         <a href="<?php echo e(route('dashboard.edit', ['id' => Auth::user()->id])); ?>" class="btn btn-info flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <?php if(Auth::check() && Auth::user()->admin_status == 1): ?>
               <a href="<?php echo e(route('dashboard.editall')); ?>" class="btn btn-info flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5"  width="24">
         ...
         <li>
            <?php if(Auth::check() && Auth::user()->admin_status == 1): ?>
               <a href="<?php echo e(route('partidos.create')); ?>" class="btn btn-info flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5" width="24">
...
<div class="container mx-auto mt-8">
        <div class="grid grid-cols-3 gap-4 mb-4 bg-blue-100">
            <?php $__currentLoopData = $proximosPartidos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(!$partido->jugado): ?>  <!--Table thinked for usually having more than 3 games unplayeds -->
      ...
      <div class="p-4 sm:ml-64">
            ...
            <div class="grid grid-cols-3 gap-4">
                  ...
                  <?php $__currentLoopData = $resultadosPartidos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
                        <p class="text-2xl text-gray-400 dark:text-gray-500">
                              <?php echo e($partido->equipoLocal->nombre_equipo ?? 'Desconocido'); ?> vs <?php echo e($partido->equipoVisitante->nombre_equipo ?? 'Desconocido'); ?> - <?php echo e($partido->resultado ?? 'Sin resultado'); ?>
