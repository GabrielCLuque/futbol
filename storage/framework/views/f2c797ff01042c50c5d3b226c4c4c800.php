...
<body>
    <div class="container mx-auto p-4">
        ...
        <div class="flex justify-start mt-4">
            <a href="<?php echo e(route('dashboard.editall')); ?>" class="volver-button flex items-center text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">Volver</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\laravel\futbol\resources\views/dashboard/editone.blade.php ENDPATH**/ ?>